<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="行程距离" prop="xingchengjuli">
          <el-input v-model="ruleForm.xingchengjuli" 
              placeholder="行程距离" clearable  :readonly="ro.xingchengjuli"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="行程距离" prop="xingchengjuli">
              <el-input v-model="ruleForm.xingchengjuli" 
                placeholder="行程距离" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="交通工具" prop="jiaotonggongju">
          <el-select v-model="ruleForm.jiaotonggongju" placeholder="请选择交通工具">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="交通工具" prop="jiaotonggongju">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="攻略详情" prop="gonglvexiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gonglvexiangqing" label="攻略详情" prop="gonglvexiangqing">
                    <span v-html="ruleForm.gonglvexiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.gonglvexiangqing = this.ruleForm.gonglvexiangqing.replace(reg,'../../../springboot0q1q8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
