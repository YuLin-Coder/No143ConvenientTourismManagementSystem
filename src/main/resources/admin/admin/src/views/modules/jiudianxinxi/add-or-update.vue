<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="酒店等级" prop="jiudiandengji">
          <el-input v-model="ruleForm.jiudiandengji" 
              placeholder="酒店等级" clearable  :readonly="ro.jiudiandengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="酒店等级" prop="jiudiandengji">
              <el-input v-model="ruleForm.jiudiandengji" 
                placeholder="酒店等级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="酒店详情" prop="jiudianxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jiudianxiangqing" label="酒店详情" prop="jiudianxiangqing">
                    <span v-html="ruleForm.jiudianxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	jiudianxiangqing : false,
      ...
      rules: {
          ...
          jiudiandengji: [
                { required: true, message: '酒店等级不能为空', trigger: 'blur' },
          ],
          tupian: [
          ],
          zixundianhua: [
  ...
  methods: {
	...
	this.ruleForm.jiudianxiangqing = this.ruleForm.jiudianxiangqing.replace(reg,'../../../springboot0q1q8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
